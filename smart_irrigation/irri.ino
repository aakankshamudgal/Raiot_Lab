...
void loop() { 
  ...
  if(val == LOW) 
  {
  analogWrite(13,LOW); //if soil moisture sensor provides LOW value send LOW value to relay
  }
  else
  {
  analogWrite(13,HIGH); //if soil moisture sensor provides HIGH value send HIGH value to relay
  }
