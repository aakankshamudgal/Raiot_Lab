...
//------ wifi settings
char ssid[] = "R Lab"; //  Change this to your network SSID (name).
char pass[] = "raiotlab";  // Change this your network password

//------ MQTT broker settings and topics
const char* broker = "broker.shiftr.io"; 
char mqttUserName[] = "aakankshamudgal01";         
char mqttPass[] = "78653437685";               
